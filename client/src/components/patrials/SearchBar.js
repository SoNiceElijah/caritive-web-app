...
function SearchBar(props) {
    ...
    return (
        <div className="flex flex-row space-x-4">
            <input id="main-search-bar" onChange={onChange} className="basis-11/12 px-4 py-2 rounded border border-slate-400 focus:outline-none focus:ring focus:ring-slate-300" placeholder="Type something..." />
